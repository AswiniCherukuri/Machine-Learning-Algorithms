...
letters = pd.read_csv("C:/Users/Aswini Cherukuri/Desktop/Data Science Assignments/Python Codes/Support Vector Machines/letters.csv",low_memory=False)
letters.head()
letters.describe()
letters.columns
...
pred_df=pd.DataFrame(pred_test_linear)
