...
#Importing Data
claimants = pd.read_csv("C:/Users/Aswini Cherukuri/Desktop/Data Science Assignments/Python Codes/Logistic Regression/claimants.csv")
...
claimants.isnull().sum()
claimants.head(30)#claimants.SEATBELT = claimants.SEATBELT.fillna(claimants.SEATBELT.value_counts().index[0])
